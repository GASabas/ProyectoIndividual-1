...
# Cargar el dataset
movies_data = pd.read_csv("movies_final.csv", nrows=4000)
...
movies = preprocess_data(movies_data)

# Construcción de la matriz de características de texto
count_vectorizer = CountVectorizer(stop_words='english')
feature_matrix = count_vectorizer.fit_transform(movies['combined_features'])
